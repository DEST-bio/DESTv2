...
### get unmapped reads
  samtools view -h -@ 20 -b -f 4 $inputFile  > /scratch/aob2x/DESTv2_unmapped_reads/unmapped.${fileStem}
...
### get reads mapping to non-Drosophila genomes
  ...
  samtools view -@ 20 $inputFile $sim_chromosomes -b > /scratch/aob2x/DESTv2_unmapped_reads/nonDros.${fileStem}

### index
  samtools index /scratch/aob2x/DESTv2_unmapped_reads/unmapped.${fileStem}
  samtools index /scratch/aob2x/DESTv2_unmapped_reads/nonDros.${fileStem}

### log
  ls -lh /scratch/aob2x/DESTv2_unmapped_reads/*
