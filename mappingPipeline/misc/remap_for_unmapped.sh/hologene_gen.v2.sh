...
mkdir /scratch/aob2x/remap_for_unmapped/
mkdir -p /scratch/aob2x/remap_for_unmapped/ref
cd /scratch/aob2x/remap_for_unmapped/ref
...
C_morbifer.fasta \
E_faecalis.fasta \
P_alcalifaciens.fasta \
P_burhodogranariea.fasta \
P_entomophila.fasta \
P_rettgeri.fasta \
W_pipientis.fasta \
> holo_dmel_6.12.fa
