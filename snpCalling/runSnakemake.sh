...
#SBATCH --mem 1G
#SBATCH -o /scratch/aob2x/DESTv2_output_SNAPE/logs/runSnakemake.%A_%a.out # Standard output
#SBATCH -e /scratch/aob2x/DESTv2_output_SNAPE/logs/runSnakemake.%A_%a.err # Standard error
#SBATCH -p standard
